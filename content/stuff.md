...
My [Honours thesis](/honours/) on spanning trees in random hypergraphs became a [published paper](https://arxiv.org/abs/2005.07350). You can read the [thesis itself](/files/thesis.pdf) or an [accessible overview](/honours/). My [Erdős number](https://en.wikipedia.org/wiki/Erd%C5%91s_number) is 3 via [Professor Catherine Greenhill](https://web.maths.unsw.edu.au/~csg/).

McKinsey Global Institute papers I contributed to:
...
<ul>
<li>ECON2112: Game Theory and Business Strategy (T1 2024)</li>
<li>ECON3101: Markets and Frictions (T3 2023)</li>
<li>ECON2112: Game Theory and Business Strategy (T1 2016, T1 2017, T1 2023, T3 2023)</li>
<li>ECON3123: Organisational Economics (T3 2023)</li>
<li>MATH1231: Mathematics 1B (T2 2023)</li>
<li>ECON1102: Macroeconomics 1 (T2 2023)</li>
<li>MATH1081: Discrete Mathematics (T1 2023)</li>
<li>MATH1131: Mathematics 1A (T1 2023)</li>
<li>ECON2101: Intermediate Microeconomics (T2 2022)</li>
<li>ECON3121: Managerial Economics (T2 2017)</li>
</ul>

<p>University of Sydney:</p>

<ul>
<li>ECOS3003: Hierarchies, Incentives and Firm Structure (S2 2023)</li>
</ul>
